# Exercise 05 — Observability (Prometheus + Grafana)
...
|------|-------|-------------------|
| **U5.5 Observability** | logging, metrics, monitoring | Add Prometheus metrics to the API and set up Grafana. 5-service Compose stack. |
...
**Deadline: June 15, 2026 at 23:59 UTC-3** (3 late days allowed with penalty)

---

## Context

Add Prometheus metrics to the API and set up Grafana. 5-service Compose stack.
